...
export const LocalStateSnapshotSchema = Schema.Struct({
  ...
  authConnections: Schema.Array(AuthConnectionSchema),
  sourceAuthBindings: Schema.Array(SourceAuthBindingSchema),
  authMaterials: Schema.Array(AuthMaterialSchema),
  oauthStates: Schema.Array(OAuthStateSchema),
